...
public class ReefscapeTaskParser {
    ...
    private static Task createPickupTask(String location) {
        ...
        if (targetPose == null) { throw new IllegalArgumentException("Unknown feeder location: %s".formatted(location)); }
    ...
    private static Task createScoreTask(String location) {
        ...
        if (targetPose == null || tagID == null) { throw new IllegalArgumentException("Uknown reef location: %s".formatted(location)); }
