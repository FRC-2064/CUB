...
public class ReefscapeStateMachine extends StateMachine<ReefscapeStateMachine.WantedState, ReefscapeStateMachine.CurrentState> {
    ...
    private void handleVisionAlginment() {
        ...
        VisionAlignmentHelper.AlignmentResult result = visionHelper.alignToTarget(task.getTargetAprilTagID(), task.getTargetPose());
